...
/**
 * Stores and retrieves user account information.
 * Used for login and account creation logic.
 */
public class UserStore {
    private static final String FILE_NAME = "/Users/berk/Documents/JAVA 2024/TuneVaultFX/src/main/java/com/example/tunevaultfx/user/users.txt";
