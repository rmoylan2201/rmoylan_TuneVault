...
class RecommendationEngine {
    ...
    /**
     * Number of qualified plays (count_as_play = 1) at which the quiz boost has fully faded
     * and listening history takes over completely.
     */
     ...
     *
     * <p>The quiz acts as a strong prior when the user is new, then fades linearly as
     * real listening data accumulates:</p>
     * <ul>
     *   <li>0 qualified plays  → 100% quiz, 0% listening history</li>
     *   <li>25 qualified plays → 50% quiz, 50% listening history</li>
     *   <li>50+ qualified plays → 0% quiz, 100% listening history</li>
     * </ul>
     *
    ...
    private RecommendationProfile mergeGenreDiscovery(RecommendationProfile base,
                                                      ...
                                                      int qualifiedPlays) {
        // listeningWeight grows from 0.0 → 1.0 as qualified plays accumulate
        double listeningWeight = Math.min(1.0, (double) qualifiedPlays / QUIZ_HANDOFF_PLAYS);
